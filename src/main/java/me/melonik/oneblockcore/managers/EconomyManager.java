...
public class EconomyManager {
    ...
    public void loadFromMap(Map<UUID, Double> playerMoneyData, Map<UUID, Double> bankMoneyData) {
        if (!plugin.isVaultEnabled()) {
            this.playerMoney.clear();
            this.playerMoney.putAll(playerMoneyData);
        }

        this.bankMoney.clear();
        this.bankMoney.putAll(bankMoneyData);
    }
}