...
public class Island {
    ...
    private boolean visitorInteractionsAllowed;
    ...
    public Island(UUID ownerId, Location center) {
        ...
        this.mobDamage = true;
        this.visitable = true;
        this.visitorInteractionsAllowed = false;
    ...
    public boolean isVisitorInteractionsAllowed() {
        return visitorInteractionsAllowed;
    }

    public void setVisitorInteractionsAllowed(boolean visitorInteractionsAllowed) {
        this.visitorInteractionsAllowed = visitorInteractionsAllowed;
    }
