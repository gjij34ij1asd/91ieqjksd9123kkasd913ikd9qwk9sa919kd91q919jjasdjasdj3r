...
public class IslandUpgrades {
    ...
    public void setSpawnerCount(int spawnerCount) {
        this.spawnerCount = Math.max(0, Math.min(spawnerCount, spawnerLimit));
    }

    public void incrementSpawnerCount() {
    ...
    public void setHopperCount(int hopperCount) {
        this.hopperCount = Math.max(0, Math.min(hopperCount, hopperLimit));
    }
    ...
    public void setPistonCount(int pistonCount) {
        this.pistonCount = Math.max(0, Math.min(pistonCount, pistonLimit));
    }

    public void incrementPistonCount() {
        if (pistonCount < pistonLimit) {
            pistonCount++;
        }
    }

    public void decrementPistonCount() {
        if (pistonCount > 0) {
            pistonCount--;
        }
    }

    public int getHopperSpeedLevel() {
        return hopperSpeedLevel;
    }

    public void setHopperSpeedLevel(int hopperSpeedLevel) {
        this.hopperSpeedLevel = hopperSpeedLevel;
    }

    public int getHopperSpeedMultiplier() {
        return hopperSpeedLevel;
    }
    ...
    public static double getHopperSpeedUpgradeCost(int currentLevel) {
        switch (currentLevel) {
            case 1: return 15000;
            case 2: return 21000;
            case 3: return 30000;
    ...
    public static int getNextHopperSpeedLevel(int currentLevel) {
    ...
    public static String getUpgradeMaxLevel(String type) {
        switch (type) {
            case "BORDER": return "6";
            case "SPAWNER": return "5";
            case "HOPPER": return "5";
            case "HOPPER_SPEED": return "5";
            case "MEMBER": return "10";
            case "PISTON": return "5";
            default: return "1";
        }
    }
}